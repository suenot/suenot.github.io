...
[cmdop-claude](https://pypi.org/project/cmdop-claude/) — نهج من markolofsen. من رسوم المعرفة تُستخدم أشجار ميركل. الفكرة الأساسية: تشغيل النماذج اللغوية الصينية الرخيصة تقريباً في الخلفية لترتيب مجلد `.claude` — تجهيز السياق للنموذج الرئيسي.
...
لـ macOS يوجد حل جاهز — [Open Screenshot](https://openscreenshot.suenot.com/). الأداة تأخذ لقطات الشاشة مباشرة بتنسيق مضغوط الدقة، لا حاجة لتغيير الحجم يدوياً.
