...
export const home = {
  en: {
    ...
    about: {
      eyebrow: '01. about',
      heading: 'Who I am',
      p1_prefix: "I'm a Co-founder & CEO of ",
      p1_marketmaker_suffix: ' (an algorithmic trading platform) and Co-founder & CTO of ',
      p1_cmdop_suffix: '.',
  ...
  ru: {
    ...
    about: {
      eyebrow: '01. обо мне',
      heading: 'Кто я',
      p1_prefix: 'Я Co-founder & CEO ',
      p1_marketmaker_suffix: ' (платформа для алгоритмической торговли) и Co-founder & CTO ',
      p1_cmdop_suffix: '.',
  ...
  zh: {
    ...
    about: {
      ...
      heading: '关于我',
      p1_prefix: '我是 ',
      p1_marketmaker_suffix: '（一个算法交易平台）的联合创始人兼 CEO，同时也是 ',
      p1_cmdop_suffix: ' 的联合创始人兼 CTO。',
      p2_prefix: '我自 ',
      p2_year: '2011',
      p2_suffix:
  ...
  ko: {
    ...
    about: {
      ...
      heading: '나는 누구인가',
      p1_prefix: '저는 ',
      p1_marketmaker_suffix: '(알고리즘 트레이딩 플랫폼)의 공동창업자 & CEO이자 ',
      p1_cmdop_suffix: '의 공동창업자 & CTO입니다.',
      p2_prefix: '저는 ',
      p2_year: '2011',
      p2_suffix:
  ...
  ja: {
    ...
    about: {
      ...
      heading: '私について',
      p1_prefix: '私は ',
      p1_marketmaker_suffix: '（アルゴリズム取引プラットフォーム）の共同創業者兼 CEO であり、',
      p1_cmdop_suffix: ' の共同創業者兼 CTO でもあります。',
      p2_prefix: '',
      p2_year: '2011',
      p2_suffix:
  ...
  ar: {
    ...
    about: {
      eyebrow: '01. عنّي',
      heading: 'من أنا',
      p1_prefix: 'أنا الشريك المؤسس والرئيس التنفيذي لـ ',
      p1_marketmaker_suffix: ' (منصة تداول خوارزمي) والشريك المؤسس والمدير التقني لـ ',
      p1_cmdop_suffix: '.',
